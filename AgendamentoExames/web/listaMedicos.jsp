    ...
    <body>
        <f:view>
            ...
            <h:form>
                ...
                <h:dataTable value="#{Medico.listaMedico()}" var="medico" id="listaMedicos" border="2"
                    ...
                    <h:column>
                        <h:commandButton action="#{Medico.remove(medico.id)}" value="Excluir"/>
                    </h:column>

                    <h:column>
                        <h:commandButton action="#{Medico.loadCliente(medico.id)}" value="Alterar"/>
                    </h:column>
                </h:dataTable>

                <br/><br/>
                <a href="faces/index.jsp">Voltar para página inicial...</a>
